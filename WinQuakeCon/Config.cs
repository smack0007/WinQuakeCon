...
namespace WinQuakeCon
{
    public class Config
    {
        ...
        public bool ConsoleRemoveBorder { get; set; }

        public int ConsoleWidth { get; set; }

        public int ConsoleHeight { get; set; }

        public int ConsoleScreen { get; set; }

        public int ConsoleHiddenX { get; set; }

        public int ConsoleHiddenY { get; set; }

        public int ConsoleVisibleX { get; set; }

        public int ConsoleVisibleY { get; set; }

        public string WorkingDirectory { get; set; }

        public bool Animate { get; set; }

        public int AnimateSpeedX { get; set; }

        public int AnimateSpeedY { get; set; }
